    ...
    @push('scripts')
        ...
        <script>
            $('#submitGuestBtn').on('click', function () {
                ...
                let url = id
                    ? "{{ route('guests.update', ':id') }}".replace(':id', id)
                    : "{{ route('guests.store') }}";
        ...
        <script>
            ...
            $(document).on('click', '.view-guest', function () {
                let id = $(this).data('id');
                let url = "{{ route('guests.show', ':id') }}".replace(':id', id);
            ...
            $(document).on('click', '.blacklist-guest', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('guests.blacklist', ':id') }}".replace(':id', id),
                            type: 'POST',
            ...
            $(document).on('click', '.whitelist-guest', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('guests.whitelist', ':id') }}".replace(':id', id),
                            type: 'POST',
