<x-app-layout>
    ...
    $(document).ready(function() {
        initDataTable({
            selector: "#dataTable", ajaxUrl: "{{ route('master.nearby-attractions.ajax') }}",
    ...
    const storeUrl = "{{ route('master.nearby-attractions.store') }}";
    const updateUrl = "{{ route('master.nearby-attractions.update', ':id') }}";
    const showUrl = "{{ route('master.nearby-attractions.show', ':id') }}";
    const deleteUrl = "{{ route('master.nearby-attractions.destroy', ':id') }}";
