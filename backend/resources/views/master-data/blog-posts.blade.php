<x-app-layout>
    ...
    $(document).ready(function() {
        initDataTable({
            selector: "#dataTable", ajaxUrl: "{{ route('master.blog-posts.ajax') }}",
    ...
    const storeUrl = "{{ route('master.blog-posts.store') }}";
    const updateUrl = "{{ route('master.blog-posts.update', ':id') }}";
    const showUrl = "{{ route('master.blog-posts.show', ':id') }}";
    const deleteUrl = "{{ route('master.blog-posts.destroy', ':id') }}";
