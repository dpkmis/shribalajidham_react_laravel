<x-app-layout>
    ...
    $(document).ready(function() {
        initDataTable({
            selector: "#dataTable", ajaxUrl: "{{ route('master.festival-offers.ajax') }}",
    ...
    const storeUrl = "{{ route('master.festival-offers.store') }}";
    const updateUrl = "{{ route('master.festival-offers.update', ':id') }}";
    const showUrl = "{{ route('master.festival-offers.show', ':id') }}";
    const deleteUrl = "{{ route('master.festival-offers.destroy', ':id') }}";
