<x-app-layout>
    ...
    $(document).ready(function() {
        initDataTable({
            selector: "#dataTable", ajaxUrl: "{{ route('master.testimonials.ajax') }}",
    ...
    const storeUrl = "{{ route('master.testimonials.store') }}";
    const updateUrl = "{{ route('master.testimonials.update', ':id') }}";
    const showUrl = "{{ route('master.testimonials.show', ':id') }}";
    const deleteUrl = "{{ route('master.testimonials.destroy', ':id') }}";
