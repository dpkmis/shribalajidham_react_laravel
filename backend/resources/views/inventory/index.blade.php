    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                function updateDashboardCounts() {
                    $.get("{{ route('inventory.low-stock') }}", function(res) {
                    ...
                    $.get("{{ route('inventory.expiring') }}", function(res) {
        ...
        <script>
            $('#submitItemBtn').on('click', function () {
                ...
                let url = id
                    ? "{{ route('inventory.update', ':id') }}".replace(':id', id)
        ...
        <script>
            $(document).on('click', '.edit-item', function () {
                let id = $(this).data('id');
                let url = "{{ route('inventory.show', ':id') }}".replace(':id', id);
        ...
        <script>
            ...
            $('#submitAdjustBtn').on('click', function () {
                ...
                $.ajax({
                    url: "{{ route('inventory.adjust-stock') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        item_id: itemId,
        ...
        <script>
            $(document).on('click', '.view-history', function () {
                let id = $(this).data('id');
                let itemUrl = "{{ route('inventory.show', ':id') }}".replace(':id', id);
                let historyUrl = "{{ route('inventory.history', ':id') }}".replace(':id', id);
