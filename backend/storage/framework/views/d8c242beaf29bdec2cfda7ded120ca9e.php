                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="invoiceGuest" class="form-control">
                                ...
                                <?php $__currentLoopData = $guests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($g->id); ?>"><?php echo e($g->full_name); ?> (<?php echo e($g->email); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" id="issueDate" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                        </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                let table = initDataTable({
                    ...
                    ajaxUrl: "<?php echo e(route('financials.invoices.ajax')); ?>",
            ...
            function loadFinancialStats() {
                $.ajax({
                    url: "<?php echo e(route('financials.reports.stats')); ?>",
                    type: 'GET',
                    data: {
            ...
            $('#submitInvoiceBtn').on('click', function() {
                ...
                let url = id 
                    ? "<?php echo e(route('financials.invoices.update', ':id')); ?>".replace(':id', id)
                    : "<?php echo e(route('financials.invoices.store')); ?>";
            ...
            $(document).on('click', '.view-invoice', function() {
                let id = $(this).data('id');
                $.ajax({
                    url: "<?php echo e(route('financials.invoices.show', ':id')); ?>".replace(':id', id),
                    type: 'GET',
            ...
            $(document).on('click', '.add-payment-to-invoice', function() {
                ...
                // Get invoice balance
                $.ajax({
                    url: "<?php echo e(route('financials.invoices.show', ':id')); ?>".replace(':id', currentInvoiceId),
                    type: 'GET',
                    success: function(data) {
            ...
            $('#submitPaymentBtn').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('financials.payments.store')); ?>",
                    type: 'POST',
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        property_id: $('#propertyFilter').val() || <?php echo e($properties->first()->id ?? 'null'); ?>,
            ...
            $(document).on('click', '.cancel-invoice', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(route('financials.invoices.cancel', ':id')); ?>".replace(':id', id),
                            type: 'POST',
...
<?php endif; ?><?php /**PATH /var/www/html/wavestube/resources/views/financials/invoices/index.blade.php ENDPATH**/ ?>