...
<?php $component->withAttributes([]); ?>
    ...
    $(document).ready(function() {
        initDataTable({
            selector: "#dataTable", ajaxUrl: "<?php echo e(route('master.gallery.ajax')); ?>",
    ...
    const storeUrl = "<?php echo e(route('master.gallery.store')); ?>";
    const updateUrl = "<?php echo e(route('master.gallery.update', ':id')); ?>";
    const showUrl = "<?php echo e(route('master.gallery.show', ':id')); ?>";
    const deleteUrl = "<?php echo e(route('master.gallery.destroy', ':id')); ?>";
...
<?php endif; ?>
<?php /**PATH /var/www/html/shri_balaji_dham/backend/resources/views/master-data/gallery.blade.php ENDPATH**/ ?>