                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" id="checkinDate" class="form-control" min="<?php echo e(date('Y-m-d')); ?>">
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                let table = initDataTable({
                    ...
                    ajaxUrl: "<?php echo e(route('bookings.ajax')); ?>",
            ...
            function loadBookingStats() {
                $.ajax({
                    url: "<?php echo e(route('bookings.stats')); ?>",
                    type: 'GET',
                    data: {
            ...
            function initGuestSelect2() {
                ...
                $('#guestSelect').select2({
                    ...
                    ajax: {
                        url: "<?php echo e(route('guests.search')); ?>",
                        dataType: 'json',
                        delay: 250,
        ...
        <script>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control room-type-select" data-index="${roomAssignmentCounter}">
                                    ...
                                    <?php $__currentLoopData = $roomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($rt->id); ?>" data-rate="<?php echo e($rt->default_rate); ?>">
                                            <?php echo e($rt->name); ?> (₹<?php echo e(number_format($rt->default_rate, 2)); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
            ...
            function checkRoomAvailability(index) {
                ...
                $.ajax({
                    url: "<?php echo e(route('bookings.check-availability')); ?>",
                    type: 'POST',
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
        ...
        <script>
            $('#submitBookingBtn').on('click', function () {
                ...
                let url = id 
                    ? "<?php echo e(route('bookings.update', ':id')); ?>".replace(':id', id)
        ...
        <script>
            $(document).on('click', '.view-booking', function () {
                let id = $(this).data('id');
                let url = "<?php echo e(route('bookings.show', ':id')); ?>".replace(':id', id);
                    ...
                    success: function (data) {
                        ...
                        if (data.booking_rooms && data.booking_rooms.length > 0) {
                            data.booking_rooms.forEach(function(bookingRoom) {
                                ...
                                let roomTypeOptions = '';
                                <?php $__currentLoopData = $roomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    roomTypeOptions += `<option value="<?php echo e($rt->id); ?>" data-rate="<?php echo e($rt->default_rate); ?>" ${bookingRoom.room_type_id == <?php echo e($rt->id); ?> ? 'selected' : ''}><?php echo e($rt->name); ?> (₹<?php echo e(number_format($rt->default_rate, 2)); ?>)</option>`;
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <script>
            $(document).on('click', '.checkin-booking', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(route('bookings.checkin', ':id')); ?>".replace(':id', id),
                            type: 'POST',
            ...
            $(document).on('click', '.checkout-booking', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(route('bookings.checkout', ':id')); ?>".replace(':id', id),
                            type: 'POST',
                            data: { _token: "<?php echo e(csrf_token()); ?>" },
                            success: function(res) {
                                success_noti(res.message);
            ...
            $(document).on('click', '.cancel-booking', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(route('bookings.cancel', ':id')); ?>".replace(':id', id),
                            type: 'POST',
        ...
        <script>
            ...
            $('#submitChargeBtn').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('bookings.add-charge', ':id')); ?>".replace(':id', currentBookingId),
                    type: 'POST',
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        type: type,
        ...
        <script>
            $(document).on('click', '.add-payment', function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('bookings.show', ':id')); ?>".replace(':id', currentBookingId),
                    type: 'GET',
                    success: function(data) {
            ...
            $('#submitPaymentBtn').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('bookings.add-payment', ':id')); ?>".replace(':id', currentBookingId),
                    type: 'POST',
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        amount: amount,
...
<?php endif; ?><?php /**PATH /var/www/html/shri_balaji_dham/backend/resources/views/bookings/index.blade.php ENDPATH**/ ?>