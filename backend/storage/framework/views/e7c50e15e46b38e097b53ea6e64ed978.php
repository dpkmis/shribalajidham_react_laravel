                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="staffShift" class="form-control">
                                <?php $__currentLoopData = $shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>"><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="attendanceDate" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                let table = initDataTable({
                    selector: "#staffTable",
                    ajaxUrl: "<?php echo e(route('housekeeping-staff.ajax')); ?>",
        ...
        <script>
            $('#submitStaffBtn').on('click', function () {
                ...
                let url = id
                    ? "<?php echo e(route('housekeeping-staff.update', ':id')); ?>".replace(':id', id)
                    : "<?php echo e(route('housekeeping-staff.store')); ?>";
        ...
        <script>
            $(document).on('click', '.edit-staff', function () {
                let id = $(this).data('id');
                let url = "<?php echo e(route('housekeeping-staff.show', ':id')); ?>".replace(':id', id);
        ...
        <script>
            $(document).on('click', '.view-workload', function () {
                let id = $(this).data('id');
                let url = "<?php echo e(route('housekeeping-staff.workload', ':id')); ?>".replace(':id', id);
        ...
        <script>
            $(document).on('click', '.mark-attendance', function () {
                ...
                $.get(url, function(data) {
                    ...
                    $('#attendanceDate').val('<?php echo e(date("Y-m-d")); ?>');
            ...
            $('#submitAttendanceBtn').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('housekeeping-staff.mark-attendance')); ?>",
                    type: "POST",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        staff_id: staffId,
        ...
        <script>
            $(document).on('click', '.toggle-status', function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('housekeeping-staff.toggle-status')); ?>",
                    type: "POST",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        staff_id: id
        ...
        <script>
            $(document).on('click', '.delete-staff', function () {
                ...
                Swal.fire({
                    ...
                    let url = "<?php echo e(route('housekeeping-staff.destroy', ':id')); ?>".replace(':id', id);
                    $.ajax({
                        url: url,
                        type: "POST",
                        data: {
...
<?php endif; ?><?php /**PATH /var/www/html/shri_balaji_dham/backend/resources/views/housekeeping/staff/index.blade.php ENDPATH**/ ?>