...
<?php $component->withAttributes([]); ?>
    ...
    $(document).ready(function() {
        let table = initDataTable({
            selector: "#dataTable", ajaxUrl: "<?php echo e(route('master.tour-packages.ajax')); ?>",
    ...
    const storeUrl = "<?php echo e(route('master.tour-packages.store')); ?>";
    const updateUrl = "<?php echo e(route('master.tour-packages.update', ':id')); ?>";
    const showUrl = "<?php echo e(route('master.tour-packages.show', ':id')); ?>";
    const deleteUrl = "<?php echo e(route('master.tour-packages.destroy', ':id')); ?>";
...
<?php endif; ?>
<?php /**PATH /var/www/html/shri_balaji_dham/backend/resources/views/master-data/tour-packages.blade.php ENDPATH**/ ?>