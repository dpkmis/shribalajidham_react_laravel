    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                let table = initDataTable({
                    ...
                    ajaxUrl: "<?php echo e(route('room-features.ajax')); ?>",
        ...
        <script>
            $('#submitFeatureBtn').on('click', function () {
                ...
                let url = id
                    ? "<?php echo e(route('room-features.update', ':id')); ?>".replace(':id', id)
                    : "<?php echo e(route('room-features.store')); ?>";
        ...
        <script>
            $(document).on('click', '.edit-feature', function () {
                let id = $(this).data('id');
                let url = "<?php echo e(route('room-features.show', ':id')); ?>".replace(':id', id);
        ...
        <script>
            $(document).on('click', '.delete-feature', function () {
                ...
                Swal.fire({
                    ...
                    let url = "<?php echo e(route('room-features.destroy', ':id')); ?>".replace(':id', id);
                    $.ajax({
                        url: url,
                        type: "POST",
                        data: {
...
<?php endif; ?><?php /**PATH /var/www/html/shri_balaji_dham/backend/resources/views/room-features/index.blade.php ENDPATH**/ ?>